...
def solve_maze(direction):
    ...
    end_x, end_y = mazerun.find_edge(direction, obst_import)
    solution = mazerun.search(direction, position_x, position_y,\
                            end_x, end_y, obst_import)
    wayout = mazerun.backRoute(solution, end_x, end_y, position_x, position_y)
